...
-- -----------------------------------------------------
-- Table `yschool_lite`.`Section`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `yschool_lite`.`Section` (
  `idSection` INT NOT NULL AUTO_INCREMENT ,
  `section_name` VARCHAR(45) NULL ,
  `Sectioncol` VARCHAR(45) NULL ,
...
CREATE  TABLE IF NOT EXISTS `yschool_lite`.`Classroom` (
  ...
  CONSTRAINT `fk_Classroom_Section1`
    ...
    REFERENCES `yschool_lite`.`Section` (`idSection` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `yschool_lite`.`Exam_Type`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `yschool_lite`.`Exam_Type` (
...
CREATE  TABLE IF NOT EXISTS `yschool_lite`.`Exam` (
  ...
  CONSTRAINT `fk_Exam_Exam_Type1`
    ...
    REFERENCES `yschool_lite`.`Exam_Type` (`idExam_Type` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE  TABLE IF NOT EXISTS `yschool_lite`.`Class_Student` (
  `idClass_Student` VARCHAR(45) NOT NULL ,
  `Class_idClass` INT NOT NULL ,
  `Student_idStudent` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `yschool_lite`.`User_Role`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `yschool_lite`.`User_Role` (
...
CREATE  TABLE IF NOT EXISTS `yschool_lite`.`user` (
  ...
  CONSTRAINT `fk_user_User_Role1`
    ...
    REFERENCES `yschool_lite`.`User_Role` (`idUser_Role` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `yschool_lite`.`Student_Class_Subject`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `yschool_lite`.`Student_Class_Subject` (
  `idStudent_Class_Subject` INT NOT NULL AUTO_INCREMENT ,
  `Class_Student_idClass_Student` VARCHAR(45) NOT NULL ,
  ...
  CONSTRAINT `fk_Student_Class_Subject_Class_Student1`
    ...
    REFERENCES `yschool_lite`.`Class_Student` (`idClass_Student` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `yschool_lite`.`Role`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `yschool_lite`.`Role` (
...
-- -----------------------------------------------------
-- Table `yschool_lite`.`Staff_has_Role`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `yschool_lite`.`Staff_has_Role` (
  ...
  CONSTRAINT `fk_Staff_has_Role_Role1`
    ...
    REFERENCES `yschool_lite`.`Role` (`idRole` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `yschool_lite`.`Class_Subject_has_Staff_has_Role`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `yschool_lite`.`Class_Subject_has_Staff_has_Role` (
  `Class_Subject_idClass_Subject` INT NOT NULL ,
  ...
  CONSTRAINT `fk_Class_Subject_has_Staff_has_Role_Staff_has_Role1`
    ...
    REFERENCES `yschool_lite`.`Staff_has_Role` (`idStaff_has_role` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `yschool_lite`.`Classroom_has_Staff_has_Role`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `yschool_lite`.`Classroom_has_Staff_has_Role` (
...
-- -----------------------------------------------------
-- Table `yschool_lite`.`School_has_Staff_has_Role`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `yschool_lite`.`School_has_Staff_has_Role` (
  ...
  CONSTRAINT `fk_School_has_Staff_has_Role_School1`
    ...
    REFERENCES `yschool_lite`.`School` (`idSchool` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `yschool_lite`.`Section_has_Staff_has_Role`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `yschool_lite`.`Section_has_Staff_has_Role` (
