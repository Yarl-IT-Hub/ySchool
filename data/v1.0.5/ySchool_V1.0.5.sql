...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `yschool`.`classroom_subject` ;
...
CREATE  TABLE IF NOT EXISTS `yschool`.`classroom_subject` (
  ...
  INDEX `fk_classroom_subject_classroom1_idx` (`classroom_idclassroom` ASC) ,
  CONSTRAINT `fk_classroom_has_subject_subject1`
    FOREIGN KEY (`subject_idsubject` )
    REFERENCES `yschool`.`subject` (`idsubject` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_classroom_subject_classroom1`
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `yschool`.`student_classroom_subject` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `yschool`.`classroom_subject_has_staff_has_role` ;
